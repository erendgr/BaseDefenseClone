...
{
    public class FindEnemy : SoldierBaseStates
    {
        ...
        public FindEnemy(ref SoldierAIWorker manager, ref NavMeshAgent agent)
        {
            _manager = manager;
            _agent = agent;
        }
        ...
        public override void UpdateState()
        {
            ...
            {
                _manager.SwitchState(SoldierStates.FindEnemy);
            }
